<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ren3.aspx.cs" Inherits="_3Glist.ren3" %>
...
<body background='background1.jpg' style="background-repeat: round">
    ...
    <div>
        ...
        <asp:Button ID="Button2" runat="server" Text="更新清单" onclick="Button2_Click" style="height: 21px" />
                </td>
            </tr>
            <tr>
