<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ren2.aspx.cs" Inherits="_3Glist.ren2" %>
...
<body background='background1.jpg' style="background-repeat: round">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:3glist %>" 
            ProviderName="<%$ ConnectionStrings:3glist.ProviderName %>" 
            SelectCommand="SELECT Top 30 * FROM t_ply_base Where c_status = '0' order by NEWID()">
                <SelectParameters>
        ...
        <table style="width:100%;">
            <tr>
                <td>
        <asp:HyperLink ID="返回主页" runat="server" NavigateUrl="~/Main.aspx">返回主页</asp:HyperLink>
                </td>
